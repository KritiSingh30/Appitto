...
<body>
    ...
    <main>
        ...
        <section class="reserve" id="reserveTable">
            ...
            <p class="section-text">Appitto displays an inspiring take on French cuisine in a relaxing environment. we believe in everything at its prime. Our focus is to bring the best and most responsibly sourced ingredients to the table.</p>
            <div class="booking">
                <form action="" class="myform" onsubmit= "return validateForm()">
                  <label for="guests"></label>
                  <input type="number" id="guests" name="guests" min="2" max="8" placeholder="Number of guests" required>
                  <label for="phone"></label>
                  <input type="tel" id="phone" name="phone" placeholder="Phone number" pattern="[0-9]{5}-[0-9]{5}" required>
                  ...
                  <div id="submitbtn">
                    <svg  id="cutlery" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 380.7 380.7" ><path d="M190.4 29.8a160.5 160.5 0 00-69.1 305.3l5-97.1s-9.5-3.1-11.5-4.1c-20-8.8-34.6-34.8-34.6-68.6 0-36.8 28.5-68.5 56.1-68.8h.1c27.7.3 56.2 32 56.2 68.8 0 33.8-14.6 59.7-34.6 68.6l-11.6 4.2 5.6 108a160.2 160.2 0 0089.4-3.6l5-96.3a51.6 51.6 0 01-31.3-21.6c-8.7-13 6.7-128.1 6.7-128.1h10v108h10v-108h10.8v108h9.8v-108h11.3v108h10v-108h7.6s15.3 115 6.7 128c-7 10.4-18 18.7-31 21.7l-.4.2 4.3 82.7a160.3 160.3 0 00-80.5-299.3z"/><path d="M103.7 149c.5-2.4 1.3-4.6 1.3-4.6.3-.9-.2-1.8-1.1-2.4-1-.5-2-.2-2.5.6l-2.7 4.3a46.5 46.5 0 00-4.6 10.2c-1 3.9-2.4 9-3 14.8a40.6 40.6 0 001.4 17.7c3.1 9 5.5 17.7 14.3 26.2 2.8 2.9 5.6 4.8 7.7 6.2l.7.6 1.3.8c1.7.9 2.9 1.2 3 1.2 1 .3 1.8-.2 2.2-.8.3-.8 0-1.7-.6-2.3 0 0-1-.8-2.3-2.5-.9-1-1.8-2.4-3-4l-2.5-3.7c-4.3-6.5-6.7-15.6-10.1-25-.7-2-1.3-4.6-1.5-6.8a97 97 0 012-30.5z"/><path d="M190.4 0C85.4 0 0 85.4 0 190.4c0 104.9 85.4 190.3 190.4 190.3s190.3-85.4 190.3-190.3C380.7 85.4 295.3 0 190.4 0zm0 366.5c-97.2 0-176.2-79-176.2-176.1 0-97.2 79-176.2 176.2-176.2 97.1 0 176.1 79 176.1 176.2 0 97-79 176.1-176.1 176.1z"/></svg>
                    <span>Reserve</span>
                  </div>
                  </form> 
            </div>
